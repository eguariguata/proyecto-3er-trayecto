...
function count_users($conn){
  ...
  $result = pg_query($conn, "SELECT count(*) FROM usuario where tipousuario<>'administrador'"); 
...
function get_users_paging($conn,$page,$count_per_page) {
	...
	$sql = "SELECT * from usuario ORDER  BY nombreusuario LIMIT  $count_per_page offset $offset";
