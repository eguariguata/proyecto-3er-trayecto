...
<link href="css/icons.min.css" rel="stylesheet" type="text/css" />
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="text-sm-right">
                                                 <a href="index.php?controller=users&add" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Usuario</a>      
                                                </div>
                                            </div>
                                        </div>
   ...
   <a href="index.php?controller=users&perfil=<?php echo $row['idusuario']; ?> "><button type="button" class="btn btn-icon btn-primary btn-sm"> <i class="fa fa-eye"></i> </button></a>
                          </td>
                         </tr>                        
                   <?php } ?>
                                            </tbody>
