  ...
  <meta charset="utf-8" />
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edición de registro</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col-sm-12 card bg-primary card-heady profile-user-box media-body">
                                          <h2 class="mt-1 mb-1 text-dark text-center">CENTRO DE EDUCACIÓN INICIAL  NACIONAL SIMONCITO PARQUE LA PAZ</h2>
                                          <h3 class="mt-1 mb-1 text-white text-center">Sistema de Pre-inscripción</h3>
                                        </div> <!-- end col-->
                                      </div>
                                    <div class="row justify-content-center">
                                        <div class=" text-center col-sm-4 card bg-success card-heady profile-user-box media-body">
                                          <h3 class="mt-1 mb-1 text-white">FICHA DE EDICION REGISTRO</h3>
                                        </div> <!-- end col-->
                                      </div>
                             <?php if (isset($msg)){ ?>
        ...
        <form class="needs-validation" novalidate="" method="post" action="index.php?controller=users&regi">
           ...
           <div class="col-3 col-md-3 mb-3">
            <div class="form-group">
              <label for="fecharegistro">Fecha de Registro Escolar</label>
            ...
            <div class="row">
              <div class="col-sm-12 card bg-primary card-heady profile-user-box media-body">
                <h4 class="mt-1 mb-1 text-white">DATOS DE REGISTRO ESCOLAR</h4>
              </div> <!-- end col-->
            </div>
            <br>
    <!-- inicio row -->
            <div class="row">
              ...
              <div class="col-4 col-md-4 mb-3">
                <div class="form-group">
                  ...
                  <select class="form-control" id="anoescolar" name="anoescolar" placeholder="Seleccione...">
              ...
              <div class="col-4 col-md-4 mb-3">
                <div class="form-group">                
                  ...
                  <select class="form-control" id="seccion" name="seccion" placeholder="Seleccione...">
              ...
              <div class="row">
                <div class="col-4 col-md-4 mb-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="telefono1" name="telefono1" placeholder="0" value="0"><span class="add-on"></span>
                    <div class="invalid-feedback">
                      Por favor ingrese los datos correspondientes.
                    </div>
                  </div>
    ...
    <!-- inicio row -->
              ...
              <div class="row">
               <div class="col-4 col-md-4 mb-3">
                <div class="form-group">
                  <label for="estcedulaescolar">Cédula Escolar</label>
...
<!-- inicio row -->
    ...
    <!-- inicio row -->
              <div class="row">
                ...
                <div class="col-4 col-md-4 mb-3">
                 ...
                 <div class="col-4 col-md-4 mb-3">
                <div class="form-group">
                  <label for="famcedulaescolar">Cédula Escolar</label>
                  <input type="text" class="form-control" maxlength="12" id="famcedulaescolar" name="famcedulaescolar" placeholder="Cédula Escolar" value="<?php if (isset($_POST['cedulaescolar'])) { ?><?= $_POST['cedulaescolar'] ?><?php } ?>" required="">
                  <div class="invalid-feedback">
                  Por favor ingrese los datos correspondientes.
                  </div>
                </div>
    ...
    <!-- inicio row -->
              ...
              <div class="row">
               <div class="col-4 col-md-4 mb-3">
                <div class="form-group">
                  <label for="repcedulaescolar">Cédula Escolar</label>
                  <input type="text" class="form-control" maxlength="12" id="repcedulaescolar" name="repcedulaescolar" placeholder="Cédula Escolar" value="<?php if (isset($_POST['cedulaescolar'])) { ?><?= $_POST['cedulaescolar'] ?><?php } ?>" required="">
                  <div class="invalid-feedback">
                  Por favor ingrese los datos correspondientes.
                  </div>
                </div>
    ...
    <!-- inicio row -->
            <div class="row">
              ...
              <div class="col-4 col-md-4 mb-3">
                <div class="form-group">
                  <label for="doccedulaescolar">Cédula Escolar</label>
                  <input type="text" class="form-control" maxlength="12" id="doccedulaescolar" name="doccedulaescolar" placeholder="Cédula Escolar" value="<?php if (isset($_POST['cedulaescolar'])) { ?><?= $_POST['cedulaescolar'] ?><?php } ?>" required="">
                  <div class="invalid-feedback">
                  Por favor ingrese los datos correspondientes.
                  </div>
                </div>
